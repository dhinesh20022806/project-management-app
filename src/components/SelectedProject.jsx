...
const SelectedProject = ({projectList, deleteTask, TaskList, id, handleDelete, handleSubmit}) => {
  ...
  return (
    <div className="w-[35rem]">
      ...
      <div className="mt-4">
        <Task handlePass={handleSubmit} deleteTask={deleteTask} taskList={TaskList} id={currentProject[0].id} />
      </div>
    </div>
  );
};
